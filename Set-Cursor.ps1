...
if ((Test-Path -LiteralPath 'HKCU:\SOFTWARE\Microsoft\Accessibility') -ne $true)
{
    New-Item 'HKCU:\SOFTWARE\Microsoft\Accessibility' -Force -ErrorAction SilentlyContinue | Out-Null
}
...
if ((Test-Path -LiteralPath 'HKCU:\Control Panel\Cursors') -ne $true)
{
    New-Item 'HKCU:\Control Panel\Cursors' -Force -ErrorAction SilentlyContinue | Out-Null
}
...
else
{
    ...
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name '(default)' -Value 'Windows Inverted (extra large)' -PropertyType String -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'AppStarting' -Value "$cursorsFolder\wait_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'Arrow' -Value "$cursorsFolder\arrow_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'ContactVisualization' -Value 1 -PropertyType DWord -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'Crosshair' -Value "$cursorsFolder\cross_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'CursorBaseSize' -Value 80 -PropertyType DWord -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'GestureVisualization' -Value 31 -PropertyType DWord -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'Hand' -Value "$cursorsFolder\aero_link_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'Help' -Value "$cursorsFolder\help_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'IBeam' -Value "$cursorsFolder\beam_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'No' -Value "$cursorsFolder\no_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'NWPen' -Value "$cursorsFolder\pen_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'Scheme Source' -Value 2 -PropertyType DWord -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'SizeAll' -Value "$cursorsFolder\move_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'SizeNESW' -Value "$cursorsFolder\size1_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'SizeNS' -Value "$cursorsFolder\size4_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'SizeNWSE' -Value "$cursorsFolder\size2_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'SizeWE' -Value "$cursorsFolder\size3_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'UpArrow' -Value "$cursorsFolder\up_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
    New-ItemProperty -LiteralPath 'HKCU:\Control Panel\Cursors' -Name 'Wait' -Value "$cursorsFolder\busy_il.cur" -PropertyType ExpandString -Force -ErrorAction SilentlyContinue | Out-Null
}
